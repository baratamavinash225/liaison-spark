...
class SemanticLayer:
    ...
    def get_context(self, query: str, k: int = 10, database_schemas: List[str] = None) -> str:
        """
        ...
        if database_schemas:
            ...
            search_kwargs["filters"] = Filter.by_property("database").contains_any(database_schemas)
